...
#elif defined(COMPATIBLE_ARCH) && COMPATIBLE_ARCH >= 800
...
#if !defined(__HGGCCC__) && defined(COMPATIBLE_ARCH) && COMPATIBLE_ARCH >= 800 && !defined(USE_ROCM)
...
__device__ __forceinline__ void cp_async_wait_group() {
  ...
  __syncwarp();
#elif defined(COMPATIBLE_ARCH) && COMPATIBLE_ARCH >= 800 && !defined(USE_ROCM)
