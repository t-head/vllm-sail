...
void selective_scan_fwd_launch(SSMParamsBase &params, hggcStream_t stream) {
...
#else
                    STD_CUDA_CHECK(hggcFuncSetAttribute(
...
void selective_scan_fwd_cuda(SSMParamsBase &params, hggcStream_t stream) {
...
template void selective_scan_fwd_cuda<torch::headeronly::BFloat16, float, torch::headeronly::BFloat16>(SSMParamsBase &params, hggcStream_t stream);
template void selective_scan_fwd_cuda<torch::headeronly::BFloat16, float, float>(SSMParamsBase &params, hggcStream_t stream);
template void selective_scan_fwd_cuda<torch::headeronly::Half, float, torch::headeronly::Half>(SSMParamsBase &params, hggcStream_t stream);
template void selective_scan_fwd_cuda<torch::headeronly::Half, float, float>(SSMParamsBase &params, hggcStream_t stream);
template void selective_scan_fwd_cuda<float, float, float>(SSMParamsBase &params, hggcStream_t stream);
